const atos = require('./data/mergedResults.json').data.atos;
const fs = require('fs');
...
(async () => {
    ...
    await fs.writeFileSync("./planalto/lei-ordinaria/data/finalResults.json", JSON.stringify({ data: final }, null, 4));
    await fs.writeFileSync("./planalto/lei-ordinaria/data/teste.html", final[152].html);
})();
const results = require("./data/mergedResults.json");
...
(async () => {
    ...
    await fs.writeFileSync("./easysearch/lei-ordinaria/data/filteredResults.json", JSON.stringify({ data: filtered }, null, 4));
})();